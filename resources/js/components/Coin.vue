  ...
  <section class="p-coinranking__container">
    ...
    <div class="p-coinranking__table" v-if="hour_show">
      ...
      <table>
        ...
        <td>{{ i + 1 }}</td><td><a :href="'https://twitter.com/search?q=' + coin.coins_name + '&src=typed_query'" target="_blank">{{coin.coins_name}}</a></td> <td>{{coin.hour}}</td>
        </tr>
      </table>
    </div>
    ...
    <div class="p-coinranking__table" v-if="day_show">
      ...
      <table>
        ...
        <td>{{ i + 1 }}</td><td><a :href="'https://twitter.com/search?q=' + coin.coins_name + '&src=typed_query'" target="_blank">{{coin.coins_name}}</a></td> <td>{{coin.day}}</td>
        </tr>
      </table>
    </div>
    ...
    <div class="p-coinranking__table" v-if="week_show">
      ...
      <table>
        ...
        <td>{{ i + 1 }}</td><td><a :href="'https://twitter.com/search?q=' + coin.coins_name + '&src=typed_query'" target="_blank">{{coin.coins_name}}</a></td> <td>{{coin.week}}</td>
        </tr>
      </table>
    </div>
    ...
    <div v-for="pcoin in showCoins" class="p-coinranking__table">
      <h3><a :href="'https://twitter.com/search?q=' + pcoin.coins_name + '&src=typed_query'" target="_blank">{{ pcoin.coins_name }}</a></h3>
      <h4>ツイート数集計</h4>
      <table>
